  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/profile/:id' element={user?<Profile/>:<NoAccess/>}></Route>
        <Route exact path='/edit/profile/:id' element={user ? <EditProfile/> :<NoAccess/>}></Route>
        <Route exact path='/people' element={<h1 style={{textAlign:"center",transform:"translateY(30vh)",fontSize:"40px"}}> 🙈 <br /> Coming Soon ...</h1>}></Route>
